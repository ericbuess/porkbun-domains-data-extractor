...
domains_in_use = ["asi.bible","chatgpt.recipes","gptprime.ai","bom.chat","bookofmormon.chat","standardworks.chat","standard-works.chat","sermonwriter.ai","hemeonc.ai","chatgpt.makeup","ai-domains.forsale","cardiology.chat", "gptprime.chat"]
